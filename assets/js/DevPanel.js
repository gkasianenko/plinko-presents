...
export class DevPanel {
        ...
        this.panel.innerHTML = `
            <div class="dev-panel-row">
                <select id="dev-mode-selector">
                    <option value="click" ${this.currentSettings.mode === 'click' ? 'selected' : ''}>Click</option>
                    <option value="auto" ${this.currentSettings.mode === 'auto' ? 'selected' : ''}>Auto</option>
                </select>
            </div>
    ...
    static getSettingsFromURL() {
        ...
        const settings = {
            mode: params.get('mode') || (import.meta.env.GAME_MODE || 'click'),
        };
