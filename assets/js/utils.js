import formatKoreanWon from "./koreanWonFormatter";
...
const isKoreanCurrency = CURRENCY === "₩";
...
function calculateMultiplier(binIndex, totalBins) {
  ...
  const multiplier =
    1 + Math.floor(15 * normalizedDistance * normalizedDistance);
...
const animateNumber = (options) => {
  ...
  function animate(currentTime) {
    ...
    if (isKoreanCurrency) {
      element.textContent = formatKoreanWon(currentNumber * CURRENCYVALUE);
      console.log(currentNumber, "currentNumber")
      console.log(currentNumber * CURRENCYVALUE, "currentNumber * CURRENCYVALUE")
    } else {
...
export { calculateMultiplier, animateNumber, CURRENCY, CURRENCYVALUE, isKoreanCurrency };
